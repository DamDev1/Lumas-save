    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.form}>
                <Text style={{ fontSize: 25, fontWeight: 500 }}>Welcome Back</Text>
                ...
                <View style={{ marginTop: 25, display: "flex", flexDirection: "column", gap: 25 }}>
                    ...
                    <View style={{ display: "flex", justifyContent: "flex-end", alignItems: "flex-end" }}>
                        <TouchableOpacity style={{ backgroundColor: Colors.MainColor, padding: 17, paddingHorizontal: 40, borderRadius: 10 }} >
                            <Text style={{ fontSize: 17, color: Colors.PrimaryColor }}>Login</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
            ...
            <View style={{
                ...
                <TouchableOpacity  onPress={() => navigation.navigate('SignUp')}><Text style={{ color: Colors.MainColor, fontWeight: "500" }}>Sign Up</Text></TouchableOpacity>
            </View>
        </View>
    )
}
